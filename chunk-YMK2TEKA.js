import{ca as q,da as g,ia as A,la as P}from"./chunk-6KC5HOCA.js";import{c as Q,e as E,i as N,m as O}from"./chunk-QL2AGUDK.js";import{Aa as o,Ab as F,Db as f,Fb as m,Gb as y,Lb as j,Ma as b,Mb as S,N as v,Na as C,O as h,Qa as $,Sa as r,Sb as z,T,ba as p,cb as i,fb as k,gb as I,mc as B,nb as u,ob as d,pb as x,qb as M,rb as w,yb as l,zb as D}from"./chunk-5DVEH5ZE.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
