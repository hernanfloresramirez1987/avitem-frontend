...
@Component({
    selector: '[app-topbar]',
    standalone: true,
    imports: [RouterModule, StyleClassModule, FormsModule, Ripple, InputText, ButtonModule, IconField, InputIcon, NgClass],
    template: `
        <div class="layout-topbar">
          <a class="app-logo" routerLink="/">
            <img alt="app logo" [src]="logo" style="width: 150px; height: auto;" />
