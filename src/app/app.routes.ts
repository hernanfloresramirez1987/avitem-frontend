...
export const routes: Routes = [
    {
      ...
      children: [
        ...
        { path: 'transactions', data: { breadcrumb: 'Transcciones' }, loadChildren: () => import('./core/components/pages/transactions/purchases-routing.module').then( m => m.PurchasesRoutingModule) }
      ]
    }
  ];