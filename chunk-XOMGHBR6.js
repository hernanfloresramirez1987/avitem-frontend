import{ca as q,da as g,ia as A,la as P}from"./chunk-Z4B5FZRR.js";import{c as Q,e as E,i as N,n as O}from"./chunk-PZZ6QWDK.js";import{Aa as o,Ab as D,Bb as F,Eb as f,Gb as m,Hb as y,Ma as b,Mb as j,N as v,Na as C,Nb as S,O as h,Qa as $,Sa as r,T,Ub as z,ba as p,cb as i,fb as k,gb as I,nb as u,ob as d,oc as B,pb as x,qb as M,rb as w,zb as l}from"./chunk-H3HIGMDG.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
