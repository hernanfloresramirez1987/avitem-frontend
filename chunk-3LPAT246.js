import{da as q,ea as g,ja as A,ma as P}from"./chunk-6X2GXSHH.js";import{j as Q,l as E,p as N,t as O}from"./chunk-JTR3XAHS.js";import{$a as i,Bb as m,Ca as o,Cb as y,Gb as j,Hb as S,Na as b,Nb as z,Oa as C,P as v,Q as h,Ra as $,Ta as r,V as T,cb as k,da as p,db as I,gc as B,kb as u,lb as d,mb as x,nb as M,ob as w,vb as l,wb as D,xb as F,zb as f}from"./chunk-4PTIY3UM.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
