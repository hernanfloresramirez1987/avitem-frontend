import{ca as q,da as g,ia as A,la as P}from"./chunk-AC5AOUNI.js";import{c as Q,e as E,i as N,m as O}from"./chunk-TMRQNNBK.js";import{Bb as l,Cb as D,Da as o,Db as F,Gb as f,Ib as m,Jb as y,Ob as j,Pa as b,Pb as S,Q as v,Qa as C,R as h,Ta as $,Va as r,Vb as z,W as T,ea as p,fb as i,ib as k,jb as I,pc as B,qb as u,rb as d,sb as x,tb as M,ub as w}from"./chunk-RCKDCOFB.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
